...
const ConsumptionReportElectronics = () => {
  ...
  useEffect(() => {
    getConsumptionReportData(
      `${API_URL}/getElectronicsUtilizations/graph/detailed?propertyId=2a869149-342b-44c8-ad86-8f6465970638&timeFrame=daily`,
  ...
  useEffect(() => {
    getConsumptionReportData(
      `${API_URL}/getElectronicsUtilizations/graph/detailed?propertyId=2a869149-342b-44c8-ad86-8f6465970638&timeFrame=${selectedTime}`
    );
...
export default ConsumptionReportElectronics;
